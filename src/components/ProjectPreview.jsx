...
const PROJECTS = [
  ...
  },
  {
    ...
    solution: "Created a secure branded portal where clients can track matter status, view team assignments, and download documents.",
    impact: "Clients self-serve document access and matter tracking 24/7.",
  ...
  },
  {
    ...
    solution: "Built a matter intake system that automates form capture, document generation, notifications, and matter retrieval by unique ID.",
    impact: "Reduced manual admin effort and intake turnaround time.",
  ...
  },
  {
    ...
    solution: "Built a Word task pane add-in that applies house styles, table borders, heading hierarchies, and AI-assisted paragraph classification.",
  ...
  },
  {
    ...
    solution: "Created a Power Automate flow powered by Claude AI via OpenRouter to classify attachments and route them to SharePoint.",
